        ...
        public static void Initialize(IServiceProvider serviceProvider)
        {
            using (var context = new FoodieContext(serviceProvider.GetRequiredService<DbContextOptions<FoodieContext>>()))
            {
                ...
                context.Ingredients.AddRange(
                    new Ingredient
                    {
                        IngrediantName = "Lotus Root",
                        Introduction = "Lotus root is an edible rhizome, a bulb from the flower of the same name that can be peeled, sliced, and eaten raw or cooked. It's an ancient ingredient used by emperors and villagers alike and proves so versatile, chefs have used the lotus root in salads and soups, in the main course, and also in many snack foods.",
                        ImageData = { }
                    },

                    new Ingredient
                    {
                        IngrediantName = "Shanghai Green",
                        Introduction = "Dark green, large spoon-shaped leaves with wide, light green midribs and mild flavor. Shanghai Green forms densely packed, vase-like heads. Plants can be spaced closely for baby choi, which is in demand with chefs for its tenderness and mild flavor.",
                        ImageData = { }
                    },
